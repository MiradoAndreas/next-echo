...
import { DicebearAvatar } from
  "@workspace/ui/components/dicebar-avatar";
    ...
    <div className="flex h-full flex-col bg-muted">
      ...
      <div className="p-2">
        ...
        <AIInput onSubmit={form.handleSubmit(onSubmit)}>
          <FieldGroup>
            <Controller control={form.control} name="message" disabled={conversation?.status === "resolved"} render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                ...
                <AIInputTextarea
                  ...
                  autoComplete="off" disabled={conversation?.status === "resolved"}
                  onKeyDown={(e) => {
                  ...
                  placeholder={conversation?.status === "resolved" ? "Conversation resolved" : "Ask me anything..."}
                  value={field.value}
                />
